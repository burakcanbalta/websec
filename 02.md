...
### 📸 Görsel Yerleri
- Basit `users` tablosu diyagramı
- Normal SQL sorgusu akışı
- `'` karakteriyle sorgunun kırılması
- `--` ile password kontrolünün iptali
...
### Bu Kod Neden SQL Injection'a Açık? (Red Team Yorumu)
...
### Neden Güvenli? (Prepared Statement – Blue Team Bakışı)
...
## ORM Kullanımı (En Güvenli Yaklaşım)
...
**Belirti:**
- SQL hatası ekrana basılır
- Sorgu sonucu direkt görünür
...
Eğer:
- Hata mesajı görüyorsan
- Veri sayısı artıyorsa

→ In-Band SQL Injection vardır.

---

### 2. UNION Based SQL Injection Nasıl Anlaşılır?

**Belirti:**
- Sayfada normalde olmayan veriler görünür
...
Eğer sayfa bozulmadan cevap dönüyorsa:
- UNION çalışıyordur
- Veri çekilebilir

---

### 3. Blind SQL Injection Nasıl Anlaşılır?
...
SQL Injection öğrenirken önemli olan **payload ezberlemek değil**,
**SQL'in neden kırıldığını anlamaktır**.
